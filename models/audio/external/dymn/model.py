...
from models.audio.external.MobileNetV3 import InvertedResidual
from models.audio.external.dymn.dy_block import DynamicInvertedResidualConfig, DY_Block, DynamicConv
...
pretrained_models = {
    ...
    "dymn20_as(4)": urllib.parse.urljoin(model_url, "dymn20_as_mAP_493.pt"),
